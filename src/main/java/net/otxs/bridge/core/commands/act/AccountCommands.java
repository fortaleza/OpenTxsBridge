...
import net.otxs.bridge.core.commands.act.BusinessCommands.CancelCheque;
import net.otxs.bridge.core.commands.act.BusinessCommands.CancelInvoice;
import net.otxs.bridge.core.commands.act.BusinessCommands.DiscardCheque;
import net.otxs.bridge.core.commands.act.BusinessCommands.DiscardInvoice;
import net.otxs.bridge.core.commands.act.BusinessCommands.ExcecuteCheque;
import net.otxs.bridge.core.commands.act.BusinessCommands.ExecuteInvoice;
import net.otxs.bridge.core.commands.act.ConfigCommands.SetAccount;
import net.otxs.bridge.core.dto.Account;
import net.otxs.bridge.core.dto.Transaction;
import net.otxs.bridge.core.dto.Transaction.InstrumentType;
import net.otxs.bridge.core.dto.Transaction.Side;
import net.otxs.bridge.core.exceptions.OTException;
import net.otxs.bridge.core.modules.Module;
import net.otxs.bridge.core.modules.act.AccountModule;
import net.otxs.bridge.core.modules.act.AssetModule;
import net.otxs.bridge.core.modules.act.NymModule;
	...
	public static class CreateAccount extends Command {
		...
		public static void execute(String serverId, String nymId, String assetId, String accountName) throws OTException {
			...
			if (Module.getAccountIds().size() == 1 
					|| readBooleanFromInput("Would you like to set the newly created account as your account?"))
