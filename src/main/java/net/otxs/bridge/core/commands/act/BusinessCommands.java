...
import net.otxs.bridge.core.Interpreter;
import net.otxs.bridge.core.commands.Command;
import net.otxs.bridge.core.commands.Commands;
import net.otxs.bridge.core.commands.act.ContactCommands.CreateContact;
import net.otxs.bridge.core.commands.act.ContactCommands.CreateContactAccount;
import net.otxs.bridge.core.dto.Contact;
import net.otxs.bridge.core.dto.ContactAccount;
import net.otxs.bridge.core.exceptions.OTException;
import net.otxs.bridge.core.modules.Module;
import net.otxs.bridge.core.modules.Module.AccountType;
import net.otxs.bridge.core.modules.act.AccountModule;
import net.otxs.bridge.core.modules.act.AssetModule;
import net.otxs.bridge.core.modules.act.ContactModule;
...
public class BusinessCommands extends Commands {
	...
	public static class MoveAccountToPurse extends BusinessCommand {
		...
		public void sanity() throws OTException {
			if (!Util.isValidString(DataModel.getMyAccountId()))
				error("You need to set your account first");
			if (Module.getAccountType(DataModel.getMyAccountId()).equals(AccountType.ISSUER))
				error("Cash transactions are not supported for issuer accounts");
		}
		@Override
		public Validator getValidator(int index) {
			if (index == 0) {
