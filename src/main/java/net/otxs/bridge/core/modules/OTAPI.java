...
public class OTAPI {
	...
	public static class SwigStorage {
		public static boolean exists(String folder, String s1, String s2) {
			return otapiJNI.Exists__SWIG_1(folder, s1, s2);
		}
		public static boolean exists(String folder, String s) {
			return otapiJNI.Exists__SWIG_2(folder, s);
		}
		public static boolean setPasswordCallback(OTCaller caller) {
			return otapi.OT_API_Set_PasswordCallback(caller);
		}
		public static Storable createObject(int objectType) {
			return otapi.CreateObject(objectType);
		}
		public static boolean storeObject(Storable contents, String folder, String s) {
		    return otapi.StoreObject(contents, folder, s);
		}
		...
		public static Storable queryObject(int objectType, String folder, String s) {
			return otapi.QueryObject(objectType, folder, s);
		}
	}
}
